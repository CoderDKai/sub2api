...
func TestMigrationsRunner_CreatesMailboxDomainTables(t *testing.T) {
	...
	requireColumn(t, tx, "mailbox_collectors", "business_tags", "jsonb", 0, false)
	...
	requireColumn(t, tx, "mailbox_capabilities", "connection_config", "jsonb", 0, false)
	requireColumn(t, tx, "mailbox_capabilities", "cursor_state", "jsonb", 0, false)
	requireColumn(t, tx, "mailbox_capabilities", "sync_enabled", "boolean", 0, false)
	requireColumnExists(t, tx, "mailbox_capabilities", "sync_interval_seconds")
	requireColumn(t, tx, "mailbox_capabilities", "next_sync_at", "timestamp with time zone", 0, true)
	requireColumnExists(t, tx, "mailbox_capabilities", "last_sync_at")
	requireColumnExists(t, tx, "mailbox_capabilities", "health_state")
	requireColumnExists(t, tx, "mailbox_capabilities", "last_error")
	requireColumnDefaultContains(t, tx, "mailbox_capabilities", "sync_enabled", "false")
	requireColumnDefaultContains(t, tx, "mailbox_capabilities", "health_state", "healthy")
	requireColumnNotExists(t, tx, "mailbox_capabilities", "folder")
	requireColumnNotExists(t, tx, "mailbox_capabilities", "state")
	requireColumnNotExists(t, tx, "mailbox_capabilities", "import_cursor")
	requireColumnNotExists(t, tx, "mailbox_capabilities", "last_synced_at")
	requireColumnNotExists(t, tx, "mailbox_capabilities", "sync_due_at")
	...
	requireColumnExists(t, tx, "mailbox_recipient_match_values", "source_kind")
	requireColumn(t, tx, "mailbox_recipient_match_values", "source_metadata", "jsonb", 0, false)
	requireColumnDefaultContains(t, tx, "mailbox_recipient_match_values", "source_kind", "manual")
