...
```bash
curl -sSL https://raw.githubusercontent.com/CoderDKai/sub2api/main/deploy/install.sh | sudo bash
```
...
# 卸载
curl -sSL https://raw.githubusercontent.com/CoderDKai/sub2api/main/deploy/install.sh | sudo bash -s -- uninstall -y
```
...
# 下载并运行部署准备脚本
curl -sSL https://raw.githubusercontent.com/CoderDKai/sub2api/main/deploy/docker-deploy.sh | bash
...
```bash
# 1. 克隆仓库
git clone https://github.com/CoderDKai/sub2api.git
cd sub2api/deploy
...
<a href="https://star-history.com/#CoderDKai/sub2api&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=CoderDKai/sub2api&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=CoderDKai/sub2api&type=Date" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=CoderDKai/sub2api&type=Date" />
 </picture>
</a>
