...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/mailbox/providers', label: t('nav.mailboxProviders'), icon: GlobeIcon },
    { path: '/admin/mailbox/collectors', label: t('nav.mailboxCollectors'), icon: FolderIcon },
    { path: '/admin/mailbox/recipients', label: t('nav.mailboxRecipients'), icon: UsersIcon },
    { path: '/admin/mailbox/inbox', label: t('nav.mailboxInbox'), icon: BellIcon },
